      ...
      {props.sessionStatus ? (
        <Dialog.Root open={open} onOpenChange={setOpen}>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-[50%] top-[50%] z-50 max-h-[85vh] w-[90vw] max-w-[600px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none dark:border dark:border-neutral-700 dark:bg-black">
              ...
              >
                <fieldset className="mb-[15px] flex items-center gap-5">
                  <input
                    className="w-full rounded-lg border border-neutral-600 bg-transparent p-3 text-sm"
                    id="title"
                ...
                <div className="mt-[25px] flex justify-between">
                  <p className="text-xs text-neutral-500">{postLength}/2500</p>
                  {!isLoading ? (
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center rounded-[4px] border border-black px-5 py-2 font-medium transition duration-100 hover:bg-black hover:text-white focus:shadow-[0_0_0_2px] focus:outline-none dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800"
                    >
                      Post
                    </button>
                  ) : (
                ...
                >
                  ...
                  >
                    <path
                      ...
                      stroke-width="1.5"
                      className="stroke-black dark:stroke-neutral-500"
        ...
        <Link href={"/login"}>
          <button className="inline-block rounded border border-black px-12 py-3 text-sm font-semibold text-black transition duration-100 hover:bg-black hover:text-white focus:outline-none focus:ring active:text-white dark:border-neutral-700 dark:text-white">
            Write a Post 💭
          </button>
        </Link>
      )}
