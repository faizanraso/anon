      ...
      <div className="mx-auto my-auto w-9/12 max-w-screen-xl rounded-xl bg-white px-4 py-16 shadow drop-shadow-xl sm:px-6 md:w-6/12 lg:w-4/12 lg:px-8">
        ...
        <div className="flex items-center justify-center">
          <button
            ...
            role="button"
            className="mt-10 flex items-center rounded-lg border border-neutral-900 px-7 py-3.5 transition hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-1"
        ...
        <div className="flex items-center justify-center">
          <button
            aria-label="Continue with google"
            role="button"
            className="mt-3 flex items-center rounded-lg border border-neutral-900 px-7 py-3.5 transition hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-1"
